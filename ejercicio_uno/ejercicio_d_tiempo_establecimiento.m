%% EJERCICIO D: TIEMPO DE ESTABLECIMIENTO EN LAZO ABIERTO
% Simulación de la respuesta al escalón del sistema en lazo abierto
...
fprintf('========================================\n');
fprintf('  EJERCICIO D: TIEMPO DE ESTABLECIMIENTO\n');
fprintf('========================================\n\n');

%% RESPUESTA AL ESCALÓN EN LAZO ABIERTO
figure('Name', 'Respuesta al Escalón - Lazo Abierto', 'Position', [100 100 1000 600]);
...
plot([ts_2_simulado ts_2_simulado], [0 yss*1.3], 'r:', 'LineWidth', 1.5);
plot([ts_5_simulado ts_5_simulado], [0 yss*1.3], 'g:', 'LineWidth', 1.5);
...
info_text = {
    ...
    sprintf('Valor pico: %.4f m', info_step.Peak);
    sprintf('Ganancia DC: %.4f', dcgain(G));
    '';
...
save('ejercicio_uno/resultados_lazo_abierto.mat', 'ts_lazo_abierto_2', 'ts_lazo_abierto_5', ...
     'yss', 'Mp_percent', 'info_step', 't', 'y');

% Guardar figura
saveas(gcf, 'ejercicio_uno/respuesta_lazo_abierto.fig');
saveas(gcf, 'ejercicio_uno/respuesta_lazo_abierto.png');

fprintf('\n✓ Resultados guardados en "ejercicio_uno/resultados_lazo_abierto.mat"\n');
